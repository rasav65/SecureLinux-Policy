...
CASES = [
    ...
    ("home sensitive files accepted", record("home-sensitive-files-mode", "/etc/passwd|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "bits-clear", "0077", "string", derived=True, justification="product mechanism")),
    ...
    ("authority home sensitive non-derived rejected", record("home-sensitive-files-mode", "/etc/passwd|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "bits-clear", "0077", "string")),
