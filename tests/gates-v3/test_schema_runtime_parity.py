...
CASES = [
    ...
    ("sudo root command files accepted", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w-conditional", "owner-if-regular-user;go-w-if-other-write", "string", derived=True, justification="product mechanism")),
    ("sudo root command files locator rejected", record("sudo-root-command-files-protection", "/etc/sudoers", "root-command-files", "root-owned-go-w-conditional", "owner-if-regular-user;go-w-if-other-write", "string")),
    ("sudo root command files key rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "mode", "root-owned-go-w-conditional", "owner-if-regular-user;go-w-if-other-write", "string")),
    ("sudo root command files op rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "bits-clear", "owner-if-regular-user;go-w-if-other-write", "string")),
    ("sudo root command files expected rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w-conditional", "0022", "string")),
    ...
    ("home sensitive files accepted", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "bits-clear", "0077", "string", derived=True, justification="product mechanism")),
    ("home sensitive files locator rejected", record("home-sensitive-files-mode", "/home", "mode", "bits-clear", "0077", "string")),
    ("home sensitive files key rejected", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1", "owner", "bits-clear", "0077", "string")),
    ("home sensitive files op rejected", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "eq", "0077", "string")),
    ("home sensitive files mask rejected", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "bits-clear", "0022", "string")),
    ...
    ("pam wheel accepted", record("pam-wheel-access", "/etc/pam.d/su|/etc/group", "policy", "eq-authority-file", "/etc/securelinux-policy/wheel-users.allowlist-v1", "string", derived=True, justification="product mechanism")),
    ("pam wheel locator rejected", record("pam-wheel-access", "/etc/pam.d/su", "policy", "eq-authority-file", "/etc/securelinux-policy/wheel-users.allowlist-v1", "string")),
    ("pam wheel key rejected", record("pam-wheel-access", "/etc/pam.d/su|/etc/group", "members", "eq-authority-file", "/etc/securelinux-policy/wheel-users.allowlist-v1", "string")),
    ("pam wheel op rejected", record("pam-wheel-access", "/etc/pam.d/su|/etc/group", "policy", "eq", "/etc/securelinux-policy/wheel-users.allowlist-v1", "string")),
    ("pam wheel authority rejected", record("pam-wheel-access", "/etc/pam.d/su|/etc/group", "policy", "eq-authority-file", "/tmp/wheel", "string")),
    ("sudoers reviewed accepted", record("sudoers-reviewed-policy", "/etc/sudoers", "policy-tree", "eq-reviewed-policy", "/etc/securelinux-policy/sudoers-reviewed-policy-v1", "string", derived=True, justification="product mechanism")),
    ("sudoers reviewed locator rejected", record("sudoers-reviewed-policy", "/etc/sudoers.d", "policy-tree", "eq-reviewed-policy", "/etc/securelinux-policy/sudoers-reviewed-policy-v1", "string")),
    ...
    ("authority sudo root non-derived rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w-conditional", "owner-if-regular-user;go-w-if-other-write", "string")),
    ...
    ("authority home sensitive non-derived rejected", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1", "mode", "bits-clear", "0077", "string")),
    ("authority pam wheel non-derived rejected", record("pam-wheel-access", "/etc/pam.d/su|/etc/group", "policy", "eq-authority-file", "/etc/securelinux-policy/wheel-users.allowlist-v1", "string")),
    ("authority sudoers reviewed non-derived rejected", record("sudoers-reviewed-policy", "/etc/sudoers", "policy-tree", "eq-reviewed-policy", "/etc/securelinux-policy/sudoers-reviewed-policy-v1", "string")),
...
NEWLINE_CASES = [
    ...
    ("home sensitive files locator with LF", record("home-sensitive-files-mode", "/home|/etc/securelinux-policy/home-sensitive-files-v1\n", "mode", "bits-clear", "0077", "string")),
