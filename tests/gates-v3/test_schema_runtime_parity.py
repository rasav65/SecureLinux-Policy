...
CASES = [
    ...
    ("sudo root command files accepted", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w", "uid0;bits-clear-0022", "string", derived=True, justification="product mechanism")),
    ...
    ("sudo root command files op rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "bits-clear", "uid0;bits-clear-0022", "string")),
    ("sudo root command files expected rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w", "0022", "string")),
    ...
    ("authority sudo root non-derived rejected", record("sudo-root-command-files-protection", "/etc/sudoers|/etc/securelinux-policy/sudoers-reviewed-policy-v1", "root-command-files", "root-owned-go-w", "uid0;bits-clear-0022", "string")),
