...
class R21RuntimeWriterFixtureCoverage(unittest.TestCase):
    def test_r21_contract_fixture_list_extends_r20(self):
        ...
        self.assertEqual(contract["document_id"], "MECHANISM_CONFIG_LINE_RUNTIME_V1_R21")
        self.assertEqual(tuple(contract["required_negative_fixtures"][:88]), R16_REQUIRED_FIXTURES)
        self.assertEqual(tuple(contract["required_negative_fixtures"][88:97]), R18_ADDED_FIXTURES)
        self.assertEqual(tuple(contract["required_negative_fixtures"][97:135]), R19_D17_ADDED_FIXTURES)
        self.assertEqual(tuple(contract["required_negative_fixtures"][135:143]), R20_D17_REV5_ADDED_FIXTURES)
        self.assertEqual(tuple(contract["required_negative_fixtures"][143:]), R21_D19_ADDED_FIXTURES)
