...
`DOCUMENT COMPLETE`, горизонт 1 `HORIZON1_SAFE_CLASS_APPLY_AND_VM_RUNS` закрыт,
единственный `NEXT` — Step 7B `FSTEC_AND_CORPORATE_INDEX_EXPANSION_DISPOSITIONS`. Историческая SRC-0001 APPLY-вертикаль,
