...
Current-product regression: generated docs must match machine truth, keep SRC-0005/CHECK-11 as completed history, include the completed sysctl exact-eq CHECK-17 batch and SRC-0040/CHECK-18 boundary closure, and leave systematic FSTEC expansion as the single current checkpoint.
