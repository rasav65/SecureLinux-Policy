...
# ADAPTER_REGISTRY_SHA256=c4122e0a3ef30d964dd07f05d5e30e16ffac3dd9348cb6be687011d357303a3e
...
# APPLY_IMPLEMENTATION_REGISTRY_SHA256=8370d14a7f29a156b1994e074c4ae005324534f78689dc95b251144c26fd3da0
...
SLP_RUNTIME_PATHS_PY
  ...
  if (( _slp_rc == 0 && _slp_attempt < 3 )) && [[ $_slp_obs == ERROR$'\t'* ]]; then
    case ${_slp_obs#ERROR$'\t'} in
      proc-population:process-disappeared|proc-stat:initial-starttime-changed|proc-stat:initial-endtime-changed|proc-stat:excluded-classification-vanished|proc-stat:excluded-classification-changed|pid-population:mid-snapshot-changed|proc-counter:mid-snapshot-changed|proc-stat:recheck-starttime-changed|proc-exe:recheck-missing|proc-maps:recheck-changed|proc-stat:recheck-endtime-changed|proc-stat:excluded-recheck-changed|proc-exe:excluded-reappeared|pid-population:final-snapshot-changed|proc-counter:final-snapshot-changed) command /usr/bin/sleep 1; continue ;;
    esac
  fi
  break
  done
