...
slp_presentation_for_control() {
  ...
  case "$_slp_cid" in
    ...
    'FSTEC-LINUX-2022-2.3.4-SUDO-ROOT-COMMAND-FILES-PROTECTION') printf '%s' 'fstec-linux-2022 §2.3.4	sudo-root-command-files-protection	uid=0; g/o+w=0' ;;
