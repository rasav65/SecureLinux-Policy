...
# GENERATOR_SHA256=74e5a177f05c4de37c5ea17b00af87a6f4c2f70408997b88fefa672e22c0e07f
# CONTROL_MANIFEST_SHA256=a2b3f46babb0687533f96a3410eea2cbb7bccfea384b2fc937d9c61fbf483897
# ADAPTER_REGISTRY_SHA256=ef54712dfbd6a4fa4e95f8fc37a4bd8acf79fb60b3a0518298cc65db7e00f4db
# APPLY_SCOPE=SRC-0001_ONLY
# APPLY_IMPLEMENTATION_REGISTRY_SHA256=034c986dbcf155474497c31273b38cec80cad56b34e3d7b4009fdf2a51498e45
...
slp_apply_FSTEC_LINUX_2022_2_1_1_LOCAL_ACCOUNT_PASSWORD_STATE() {
  ...
  LC_ALL=C command /usr/bin/python3 -I -S -B - "$_slp_mode" "$_slp_attestation" <<'SLP_APPLY_SRC0001_PY'
import ctypes
import ctypes.util
import errno
import hashlib
...
slp_run_apply() {
  local _slp_mode=$1 _slp_attestation=${2:-}
  slp_target_preflight || return $?
  slp_apply_FSTEC_LINUX_2022_2_1_1_LOCAL_ACCOUNT_PASSWORD_STATE "$_slp_mode" "$_slp_attestation"
  return $?
}
