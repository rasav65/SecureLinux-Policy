...
acceptance не считается действующим. Эта работа зафиксирована в машинном
roadmap отдельным шагом `SRC0008_CHECK_SEMANTIC_REWORK` со статусом
`SEMANTIC_REWORK_IN_PROGRESS`. Этап 8
