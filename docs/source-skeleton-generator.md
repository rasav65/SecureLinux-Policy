...
`Таблица ` — ссылка на таблицу, а не граница. Пункт 9.4 напечатан в источнике
как `8.4` (опечатка) после 9.3: закреплённый псевдоним ставит его в outline на
место 9.4, локатор остаётся напечатанным `8.4` (`SRC-0091`).
