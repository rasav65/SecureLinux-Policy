...
1. Решение человека, считать ли прогоны 24.09.2026 и 25.09.2026 (архив
   `slp-vm-apply-supported7-v15-states1-7-20260925-105923.tar.gz` в evidence) приёмкой
   механизмов (статус узлов `PROJECT-MAP.md`).
