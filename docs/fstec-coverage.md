...
CONTROLLED_CLOSED_WITH_CONTRACT=28
DISPOSED_CLOSED_ROWS=0
OPEN_INDEX_ROWS=321
CANONICAL_CONTROLS=37
```
...
| fstec-linux-2022 | 40 | 28 | 0 | 12 | 37 |
...
`321` source rows остаются `OPEN`. Полный перечень и их source metadata находятся в `index/source-v4/SOURCE-INDEX.tsv`; этот документ не дублирует 349 строк вручную.
