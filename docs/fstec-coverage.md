...
CONTROLLED_CLOSED_WITH_CONTRACT=17
DISPOSED_CLOSED_ROWS=0
OPEN_INDEX_ROWS=332
CANONICAL_CONTROLS=19
```
...
| fstec-linux-2022 | 40 | 17 | 0 | 23 | 19 |
...
`332` source rows остаются `OPEN`. Полный перечень и их source metadata находятся в `index/source-v4/SOURCE-INDEX.tsv`; этот документ не дублирует 349 строк вручную.
