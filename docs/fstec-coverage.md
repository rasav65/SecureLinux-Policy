...
CONTROLLED_CLOSED_WITH_CONTRACT=29
DISPOSED_CLOSED_ROWS=0
OPEN_INDEX_ROWS=320
CANONICAL_CONTROLS=38
```
...
| fstec-linux-2022 | 40 | 29 | 0 | 11 | 38 |
...
`320` source rows остаются `OPEN`. Полный перечень и их source metadata находятся в `index/source-v4/SOURCE-INDEX.tsv`; этот документ не дублирует 349 строк вручную.
