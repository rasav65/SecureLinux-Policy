...
flowchart LR
    ...
    APPLY4["suid-sgid-applications-mode-v1<br/>режимы SUID/SGID SRC-0013 · APPLY<br/>ВМ-прогона ещё нет"]:::current
...
Все четыре механизма в статусе `current`: у config-line, file-mode-owner и
optional-file-root-files-mode на ВМ пройдена одна среда, у
`suid-sgid-applications-mode-v1` ВМ-прогона ещё нет; приёмка восьми сред впереди.
...
| G6 | режимы файлов по вычисляемой стабильной популяции (системные корни cron, SUID/SGID-файлы всех непсевдо-точек монтирования), только снятие битов | `FSTEC-LINUX-2022-2.3.6-CRONTAB`, `FSTEC-LINUX-2022-2.3.6-CRON-D`, `FSTEC-LINUX-2022-2.3.6-CRON-HOURLY`, `FSTEC-LINUX-2022-2.3.6-CRON-DAILY`, `FSTEC-LINUX-2022-2.3.6-CRON-WEEKLY`, `FSTEC-LINUX-2022-2.3.6-CRON-MONTHLY`, `FSTEC-LINUX-2022-2.3.9-SUID-SGID-MODE` | да |
| G6 | режимы файлов по вычисляемой стабильной популяции (системные корни cron, SUID/SGID-файлы всех непсевдо-точек монтирования), только снятие битов | `FSTEC-LINUX-2022-2.3.5-STARTUP-FILES-WRITE-PROTECTION`, `FSTEC-LINUX-2022-2.3.8-STANDARD-SYSTEM-PATHS-MODE` | нет |
