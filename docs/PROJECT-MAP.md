...
flowchart LR
    ...
    APPLY5["standard-system-paths-mode-v1<br/>режимы системных путей SRC-0012 · APPLY<br/>ВМ: 1 среда PASS на текущем кандидате, приёмка 8 сред — впереди"]:::current
