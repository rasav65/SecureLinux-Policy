...
- `fstec-configuration-2026` — типовые ошибки конфигурации (по названию документа: «Рекомендации
  по устранению типовых ошибок конфигурации (настройки) общесистемного и прикладного
