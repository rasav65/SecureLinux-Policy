...
Принятие `standard-system-paths-mode-v1` относится к кандидату
`e170aae19cf261f37c1ca0a2f10c72b1dc373bef4eae263c6653bd690e35dd38`. Затем перечислитель
механизма исправлен (ошибка чтения подкаталога — отказ `scan:find-failed`); текущий
кандидат `ba96131bcf5b3a6d9906052a5163e2a5dca784ae3f16982a7a12df6dfb03a55b`, на новых
байтах ВМ-прогон не выполнен.
