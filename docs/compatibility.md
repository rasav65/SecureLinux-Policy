...
`startup-files-write-protection-v1` и `kernel-cmdline-grub-v1` 24.09.2026, у `pam-wheel-su-v1` 25.09.2026 выполнен прогон на семи средах; у `sshd-config-option-v1` ВМ-прогона нет. Приёмка
...
(репарация по аудиту диапазона `6780086..3215d1c`) устраняет то же
...
Репарация 22.09.2026 (аудит, диапазон `6780086..3215d1c`, B-02/B-03):
