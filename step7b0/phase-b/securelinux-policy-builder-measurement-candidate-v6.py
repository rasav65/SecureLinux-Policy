...
BUILD_CONTRACT_SHA256 = 'aeae0d190aa1e6bec97629e332873c1a9b829c2a2d0975f82215fdfc044ea1a9'
TARGET_ID='ubuntu-24.04-x86_64'
BUILDER_ID='securelinux-policy-builder-v1'
CANDIDATE_CANONICAL_PATH = 'step7b0/phase-b/securelinux-policy-builder-measurement-candidate-v6.py'
...
EXPECTED_INPUT_SHA256 = {
    ...
    'step7b0/BUILD-CONTRACT-v0.9.5.md': 'aeae0d190aa1e6bec97629e332873c1a9b829c2a2d0975f82215fdfc044ea1a9',
...
def build(root:str,staging:str,mode:str,build_inputs_lock_rel:str|None=None)->dict:
    ...
    contract=data['step7b0/BUILD-CONTRACT-v0.9.5.md'].decode('utf-8')
    if 'build_contract_version = 0.9.5' not in contract or BUILD_CONTRACT_ID not in contract:raise RuntimeError('contract identity text mismatch')
