...
BUILD_CONTRACT_SHA256 = '3f5264eca11a471bdcc87494b7b2399d7d6136af02296b6fd39dd444c5955cbf'
TARGET_ID='ubuntu-24.04-x86_64'
BUILDER_ID='securelinux-policy-builder-v1'
CANDIDATE_CANONICAL_PATH = 'step7b0/phase-b/securelinux-policy-builder-measurement-candidate-v5.py'
...
EXPECTED_INPUT_SHA256 = {
    ...
    'step7b0/BUILD-CONTRACT-v0.9.4.md': '3f5264eca11a471bdcc87494b7b2399d7d6136af02296b6fd39dd444c5955cbf',
    ...
    'step7b0/phase-a/contracts/build-environment-v2.json': '9fa66d73a492eb0c3562610fb9813c29694a2db5a8c722851ad13243d71c5b98',
...
def build(root:str,staging:str,mode:str,build_inputs_lock_rel:str|None=None)->dict:
    ...
    contract=data['step7b0/BUILD-CONTRACT-v0.9.4.md'].decode('utf-8')
    if 'build_contract_version = 0.9.4' not in contract or BUILD_CONTRACT_ID not in contract:raise RuntimeError('contract identity text mismatch')
    benv=json.loads(data['step7b0/phase-a/contracts/build-environment-v2.json'])
    if benv['contract_id']!='build-environment-v2' or benv['sanitized_environment']!=ALLOWED_ENV:raise RuntimeError('build environment mismatch')
