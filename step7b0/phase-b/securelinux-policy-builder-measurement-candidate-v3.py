...
BUILD_CONTRACT_SHA256='cc81f7702a2d940400a70f269f2082d9c4ed845fc05e338c4d50693360e499aa'
TARGET_ID='ubuntu-24.04-x86_64'
BUILDER_ID='securelinux-policy-builder-v1'
CANDIDATE_CANONICAL_PATH='step7b0/phase-b/securelinux-policy-builder-measurement-candidate-v3.py'
...
'step7b0/BUILD-CONTRACT-v0.9.2.md':'cc81f7702a2d940400a70f269f2082d9c4ed845fc05e338c4d50693360e499aa',
...
def build(root:str,staging:str,mode:str,build_inputs_lock_rel:str|None=None)->dict:
    ...
    contract=data['step7b0/BUILD-CONTRACT-v0.9.2.md'].decode('utf-8')
    if 'build_contract_version = 0.9.2' not in contract or BUILD_CONTRACT_ID not in contract:raise RuntimeError('contract identity text mismatch')
